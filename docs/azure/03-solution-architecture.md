...
A virtual appliance (virtual machine) that is deployed into the target Azure environment. The appliance brokers source and target instance configuration metadata used for orchestration.
